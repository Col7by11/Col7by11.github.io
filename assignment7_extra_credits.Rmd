...
library(lubridate)
library(knitr)
df <- read_csv('C://Users//student//OneDrive - Bryant University//Desktop//R//Col7by11.github.io/ds_salaries.csv')
```
...
5. What are the job title that have the highest average salary?
```{r}
df %>% 
  group_by(job_title) %>% 
  summarise(mean_salary = mean(salary)) %>% 
