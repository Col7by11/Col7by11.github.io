...
```{r}
df2 <- read_csv("C:\\Users\\student\\OneDrive - Bryant University\\Desktop\\R\\Col7by11.github.io\\WHO-COVID-19-global-data.csv")
df2 <- df2 %>% filter(Date_reported>= '2021-01-01'&Date_reported<='2021-12-31')
library(lubridate)
...
```{r}
df3 <- read_csv('C:\\Users\\student\\OneDrive - Bryant University\\Desktop\\R\\Col7by11.github.io\\all-states-history.csv')
